...
const createInitialUsers = async () => {
	try{
		...
		const sandra = await createUser({ username: 'sandra', password: '2sandy4me', name: 'Sandra', location: 'Not Texas' });
		const glamgal = await createUser({ username: 'glamgal', password: 'soglam', name: 'Albert', location: 'Canada' });
